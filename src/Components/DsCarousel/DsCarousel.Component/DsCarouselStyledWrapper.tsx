...
export const DsCarouselStyledWrapper = styled(DsBox, {
  shouldForwardProp: (prop) =>
    !["isAutoplayEnabled", "transitionSpeed", "isExternalPagination"].includes(prop as string),
})<SwiperContainerWrapperProps>(({ isAutoplayEnabled, transitionSpeed, isExternalPagination, sx }) => ({
  ".swiper-pagination": {
    position: "absolute",
    textAlign: "center",
